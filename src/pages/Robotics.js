        ...
        <div className="grid-container flex-container">
          <div className="flex-item-70">
            ...
            <div className="grid-item">
              ...
              <p>
                Robo No. 2 that drives, detects obstacles and can be programmed
            ...
            <div className="grid-item">
              ...
              <p>
                Robo No. 5 with 5 variants of different robots and 250
                components including a cybernetic center, 3 electric motors, 2
                IR sensors, a speaker.
              </p>
            </div>
          </div>
